...
/**
 * The card WhatsApp draws for a collections link.
 *
 ...
 * package and what arrives is an advert for fried chicken.
 */
export const alt = "Sudu packs care packages, hostel packs and gifts for PAU";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          >
            Boxes already put together
          </div>
          <div style={{ fontSize: 34, color: "rgba(255,255,255,0.7)" }}>
            Care packages, monthly foodstuff, hostel packs and gifts. One price
            with delivery in it, to their block at PAU.
          </div>
        </div>
